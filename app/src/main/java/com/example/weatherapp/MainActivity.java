...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView city, temperature, weatherCondition,
            humidity, maxTemperature, minTemperature, pressure, wind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherCondition = findViewById(R.id.textViewCondition);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent iToWeatherAct = new Intent(MainActivity.this,WeatherActivity.class);
                startActivity(iToWeatherAct);
                //now finish, allow it can come back
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                lat = location.getLatitude(); //get user lat
                lon = location.getLongitude(); //get user lon
                Log.e("LAT: ",String.valueOf(lat));
                Log.e("LON: ",String.valueOf(lon));
                getWeatherData(lat,lon);
            }
        };
        checkPermission(); //when user run the app, will ask permission
    }
        ...
        call.enqueue(new Callback<OpenWeatherMap>() {
            ...
            public void onResponse(Call<OpenWeatherMap> call, Response<OpenWeatherMap> response) {
                ...
                Picasso.get().load("https://openweathermap.org/img/wn/"+iconCode+"@2x.png")
                        .placeholder(R.drawable.ic_launcher_background).fit().into(imageView);
            }
